		...
		<?php echo form_open('', 'method="post"'); ?>
		  ...
		  <div class="form-row">
		    <div class="form-group col-md-6">
		      ...
		      <input type="email" name="email" class="form-control" id="inputEmail4" value="<?php echo $kontak['email'] ?>" required>
		    </div>
		    
		    <div class="form-group col-md-6">
		      <label for="nama_lengkap">Nama Lengkap</label>
		      <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" value="<?php echo $kontak['nama_lengkap'] ?>" required>
		    </div>
		  </div>
		  
		  <div class="form-group">
		    <label for="no_whatsapp">No. Whatsapp</label>
		    <input type="text" name="no_whatsapp" class="form-control" id="no_whatsapp" placeholder="No. Whatsapp" value="<?php echo $kontak['no_whatsapp'] ?>" required>
		  </div>

		  <div class="form-group">
		    <label for="inputAddress2">Alamat</label>
		    <input type="text" name="alamat" class="form-control" id="inputAddress2" placeholder="Alamat" value="<?php echo $kontak['alamat'] ?>" required>
		  </div>
		  ...
		  <div class="form-row">
		    ...
		    <div class="form-group col-md-2">
		      ...
		      <input type="text" name="kode_pos" class="form-control" value="<?php echo $kontak['kode_pos'] ?>" id="inputZip">
		    </div>
		  </div>
		  <!-- <div class="form-group">
