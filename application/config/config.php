...
|
*/
$config['base_url'] = 'https://localhost/belajar_ci/'; //1
...
$config['sess_save_path'] = sys_get_temp_dir(); //3
...
*/
$config['csrf_protection'] = TRUE; //5
$config['csrf_token_name'] = 'csrf_token';  //6
$config['csrf_cookie_name'] = 'csrf_cookie'; //7
...
|
*/
$config['time_reference'] = 'Asia/Jakarta'; //8
